				...
				<table>
					...
					<tr>
						<td align="center" colspan="2"><br />
							...
							<input type="checkbox" name="remember" class="inputbox" value="yes" /><br />
							<a href="<?php echo sefRelToAbs('index.php?option=com_registration&task=lostPassword'); ?>" title="<?php echo _LOST_PASSWORD; ?>">
								<?php echo _LOST_PASSWORD; ?>
							</a>
							<?php if ($params->get('registration')) { ?><br />
							<?php echo _NO_ACCOUNT; ?>
							<a href="<?php echo sefRelToAbs('index.php?option=com_registration&task=register'); ?>" title="<?php echo _CREATE_ACCOUNT; ?>">
