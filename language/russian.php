...
define('_CMN_NEXT_1', 'следующая');
define('_CMN_PREV_1', 'предыдущая');
...
define('_LOGIN_BLOCKED', 'Извините, но ваша учетная запись заблокирована. За более подробной информацией обратитесь к администратору сайта.');
define('_LOGIN_INCORRECT', 'Неправильное имя пользователя (логин) или пароль. Попробуйте ещё раз.');
define('_LOGIN_NOADMINS', 'Извините, но вы не можете войти на сайт. Администраторы на сайте не зарегистрированы.');
...
define('_INSTALL_3PD_WARN', 'Предупреждение: Установка сторонних расширений может нарушить безопасность вашего сайта. При обновлении Joostina сторонние расширения не обновляются.<br />Для получения дополнительной информации о мерах защиты своего сайта и сервера, пожалуйста, посетите <a href="http:// forum.joostina.ru" title="форум Joostina Team">Форум Joostina</a>.');
define('_INSTALL_WARN', 'По соображениям безопасности, пожалуйста, удалите каталог <span class="strong">installation</span> с вашего сервера и обновите страницу.');
define('_TEMPLATE_WARN', '<span class="strong red">Файл шаблона не найден!</span><br />Зайдите в Панель управления сайтом и выберите новый шаблон.');
...
define('_PN_L_LLAST_0', 'первая');
define('_PN_L_PREV_10', 'предыдущие 10');
define('_PN_L_PREV_1', 'предыдущая');
define('_PN_L_NEXT_1', 'следующая');
define('_PN_L_NEXT_10', 'следующие 10');
define('_PN_PAGE_NUMBER', 'страница номер');
define('_PN_L_RLAST_0', 'последняя');
...
define('_STAT_GZIP_ENABLE', 'Разрешено');
define('_STAT_GZIP_DISABLE', 'Запрещено');
...
define('_DIRS_WITH_RIGHTS', 'Для работы <span class="strong">ВСЕХ</span> функций и возможностей Joostina, <span class="strong">ВСЕ</span> указанные ниже каталоги должны быть доступны для записи!');
