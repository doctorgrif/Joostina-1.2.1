...
require_once($mosConfig_absolute_path.'/includes/openid/Auth/OpenID/SQLStore.php' );
/**
...
{
/** PECL SQLite extensions 1.0.3 and older (1.0.3 is the current release at the time of this writing) have a broken
 * sqlite_escape_string function that breaks when passed the empty string. Prefixing all strings with one character
 * keeps them unique and avoids this bug. The nonce table is write-only, so we don't have to worry about updating other
