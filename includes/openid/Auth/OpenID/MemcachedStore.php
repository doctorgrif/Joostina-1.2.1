 ...
 * People wishing to just use this store need only pay attention to the constructor.
 * @package OpenID
 */
...
{
// create memcached keys for association itself and list of associations for this server
...
// no handle given, working with list create key for list of associations
$serverKey = $this->associationServerKey($server_url);
// get list of associations
$serverAssociations = $this->connection->get($serverKey);
...
// returns false when nonce already exists otherwise adds nonce
