...
require_once($mosConfig_absolute_path.'/includes/openid/Auth/OpenID/Parse.php' );
require_once($mosConfig_absolute_path.'/includes/openid/Auth/OpenID/Message.php' );
require_once($mosConfig_absolute_path.'/includes/openid/Services/Yadis/XRIRes.php' );
