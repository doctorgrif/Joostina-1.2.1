...
require_once($mosConfig_absolute_path.'/includes/openid/Auth/OpenID/TrustRoot.php' );
require_once($mosConfig_absolute_path.'/includes/openid/Auth/OpenID/ServerRequest.php' );
