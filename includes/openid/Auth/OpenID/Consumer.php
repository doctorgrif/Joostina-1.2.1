...
require_once($mosConfig_absolute_path.'/includes/openid/Auth/OpenID/Message.php' );
require_once($mosConfig_absolute_path.'/includes/openid/Auth/OpenID/HMAC.php' );
require_once($mosConfig_absolute_path.'/includes/openid/Auth/OpenID/Association.php' );
require_once($mosConfig_absolute_path.'/includes/openid/Auth/OpenID/CryptUtil.php' );
require_once($mosConfig_absolute_path.'/includes/openid/Auth/OpenID/DiffieHellman.php' );
require_once($mosConfig_absolute_path.'/includes/openid/Auth/OpenID/KVForm.php' );
require_once($mosConfig_absolute_path.'/includes/openid/Auth/OpenID/Nonce.php' );
require_once($mosConfig_absolute_path.'/includes/openid/Auth/OpenID/Discover.php' );
require_once($mosConfig_absolute_path.'/includes/openid/Auth/OpenID/URINorm.php' );
require_once($mosConfig_absolute_path.'/includes/openid/Services/Yadis/Manager.php' );
require_once($mosConfig_absolute_path.'/includes/openid/Services/Yadis/XRI.php' );
