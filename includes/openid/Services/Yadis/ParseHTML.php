...
*/
/**
 * This class is responsible for scanning an HTML string to find META tags and their attributes.This is used by the Yadis discovery
...
/**
 * Replace HTML entities (amp, lt, gt, and quot) as well as numeric entities (e.g. #x9f;) with their actual values and
...
/**
 * Given an HTML document string, this finds all the META tags in the document, provided they are found in the
 * <HTML><HEAD>...</HEAD> section of the document.The <HTML> tag may be missing.
 * @access private
...
// if there is an opening html tag, make sure the opening head tag comes after it
...
/**
 * Looks for a META tag with an "http-equiv" attribute whose value is one of ("x-xrds-location", "x-yadis-location"), ignoring
 * case.If such a META tag is found, its "content" attribute value is returned.
