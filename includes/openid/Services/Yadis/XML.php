...
*/
/**
 * The base class for wrappers for available PHP XML-parsing extensions.To work with this Yadis library, subclasses of this
 * class MUST implement the API as defined in the remarks for this class.Subclasses of Auth_Yadis_XMLParser are used to wrap
 * particular PHP XML extensions such as 'domxml'.These are used internally by the library depending on the availability of
 ...
 * @param array $namespace_map An array of ($ns_name => $ns_uri) to be registered with the XML parser.May be empty.
 ...
 * @param string $xml_string The XML string to pass to this object's XML parser.
 ...
 * @param mixed $node A node object resulting from a previous evalXPath call.This node, if specified, provides the context
...
/**
 * This concrete implementation of Auth_Yadis_XMLParser implements the appropriate API for the 'domxml' extension which is typically
 * packaged with PHP 4.This class will be used whenever the 'domxml' extension is detected.See the Auth_Yadis_XMLParser class for
...
/**
 * This concrete implementation of Auth_Yadis_XMLParser implements the appropriate API for the 'dom' extension which is typically
 * packaged with PHP 5.This class will be used whenever the 'dom' extension is detected.See the Auth_Yadis_XMLParser class for
 * details on this class's methods.
 * @package OpenID
 */
...
/**
 * Set a default parser to override the extension-driven selection of available parser classes.This is helpful in
 * a test environment or one in which multiple parsers can be used but one is more desirable.
...
/**
 * Returns an instance of a Auth_Yadis_XMLParser subclass based on the availability of PHP extensions for XML parsing.If
 * Auth_Yadis_setDefaultParser has been called, the parser used in that call will be returned instead.
 */
