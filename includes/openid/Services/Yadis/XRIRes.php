...
require_once($mosConfig_absolute_path.'/includes/openid/Services/Yadis/XRDS.php' );
...
// TODO:
/* If we do get hits for multiple service_types, we're almost certainly going to have duplicated service entries and broken priority ordering.*/
}
