...
*/
/** Interface import */
require_once($mosConfig_absolute_path.'/includes/openid/Services/Yadis/HTTPFetcher.php' );
/**
...
$headers = explode("\r\n", $headers);
/* Expect the first line of the headers data to be something like HTTP/1.1 200 OK.Split the line on spaces and take the second token, which should be the return code.*/
$http_code = explode(" ", $headers[0]);
$code = $http_code[1];
$new_headers = array();
foreach ($headers as $header) {
