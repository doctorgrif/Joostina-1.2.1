...
/**
 * This class is the interface for HTTP fetchers the Yadis library uses.This interface is only important if you need to write a new
...
/**
 * Return whether a URL can be fetched.Returns false if the URL scheme is not allowed or is not supported by this fetcher
 ...
 * @return bool $support True if this fetcher supports HTTPS fetching; false if not.
 */
 ...
 * @param array $extra_headers An array of header strings (e.g. "Accept: text/html").
 * @return mixed $result An array of ($code, $url, $headers, $body) if the URL could be fetched; null if the URL does not
 * pass the URLHasAllowedScheme check or if the server's response is malformed.
 */
