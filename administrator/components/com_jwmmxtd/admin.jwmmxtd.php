...
if($task == 'edit') {
	...
	mosCommonHTML::loadJqueryPlugins('MultiFile');
}
...
<div id="jimgedit">
	...
	<div id="jwmmxtd_image">
		<div id="mmxtd"><img name="mainimage" id="mainimage" src="<?php echo $path; ?>" alt="" /></div>
	</div>
	<div id="jwmmxtd_panel">
		<form action="" method="POST" id="adminForm" name="adminForm" enctype="multipart/form-data" onSubmit="return false;">
		...
		<table cellpadding="0" cellspacing="0">
			...
			<tr>
				...
				<a style="cursor:pointer;" onClick="showColorPicker(this,document.adminForm.beveltl)">
					<img width="16" height="16" alt="<?php echo _JWMM_PRESS_TO_CHOOSE_COLOR?>" src="<?php echo $mosConfig_live_site.'/'.ADMINISTRATOR_DIRECTORY.'/components/com_jwmmxtd/images/color_wheel.png'; ?>">
				</a>
				</td>
			</tr>
			<tr>
				...
				<a style="cursor:pointer;" onClick="showColorPicker(this,document.adminForm.bevelrb)"><img width="16" height="16" alt="<?php echo _JWMM_PRESS_TO_CHOOSE_COLOR?>" src="<?php echo $mosConfig_live_site.'/'.ADMINISTRATOR_DIRECTORY.'/components/com_jwmmxtd/images/color_wheel.png'; ?>"></a></td>
			</tr>
		</table>
		</fieldset>
		<fieldset>
		...
		<table cellpadding="0" cellspacing="0">
			...
			<tr>
				...
				<a style="cursor:pointer;" onClick="showColorPicker(this,document.adminForm.borderc)"><img width="16" height="16" alt="<?php echo _JWMM_PRESS_TO_CHOOSE_COLOR?>" src="<?php echo $mosConfig_live_site.'/'.ADMINISTRATOR_DIRECTORY.'/components/com_jwmmxtd/images/color_wheel.png'; ?>"> </a></td>
			</tr>
		</table>
		</fieldset>
		<fieldset>
		...
		<a style="cursor:pointer;" onClick="showColorPicker(this,document.adminForm.tint)"> <img width="16" height="16" alt="<?php echo _JWMM_PRESS_TO_CHOOSE_COLOR?>" src="<?php echo $mosConfig_live_site.'/'.ADMINISTRATOR_DIRECTORY.'/components/com_jwmmxtd/images/color_wheel.png'; ?>"> </a>
		</fieldset>
		<fieldset>
		...
		<table cellpadding="0" cellspacing="0">
			...
			<td><input id="overlayc" name="overlayc" type="text" />
				<a style="cursor:pointer;" onClick="showColorPicker(this,document.adminForm.overlayc)"> <img width="16" height="16" alt="<?php echo _JWMM_PRESS_TO_CHOOSE_COLOR?>" src="<?php echo $mosConfig_live_site.'/'.ADMINISTRATOR_DIRECTORY.'/components/com_jwmmxtd/images/color_wheel.png'; ?>"> </a></td>
			</tr>
		</table>
		</fieldset>
		<fieldset>
		...
		<table cellpadding="0" cellspacing="2">
			...
			<td><input type="text" name="textcolor" id="textcolor">
				<a style="cursor:pointer;" onClick="showColorPicker(this,document.adminForm.textcolor)"> <img width="16" height="16" alt="<?php echo _JWMM_PRESS_TO_CHOOSE_COLOR?>" src="<?php echo $mosConfig_live_site.'/'.ADMINISTRATOR_DIRECTORY.'/components/com_jwmmxtd/images/color_wheel.png'; ?>"> </a> </td>
			</tr>
			<tr>
			...
			<img width="16" height="16" alt="<?php echo _JWMM_PRESS_TO_CHOOSE_COLOR?>" src="<?php echo $mosConfig_live_site.'/'.ADMINISTRATOR_DIRECTORY.'/components/com_jwmmxtd/images/color_wheel.png'; ?>"> </a> </td>
			</tr>
			<tr>
