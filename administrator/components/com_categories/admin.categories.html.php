...
?>
			...
			<th width="1%">
				<a href="javascript: saveorder( <?php echo count($rows) - 1; ?> )"><img src="images/filesave.png" width="16" height="16" alt="Сохранить порядок" /></a>
			</th>
		...
		<tr>
			<td valign="top" width="60%">
				...
				<tr>
					...
					<td colspan="2">
						<input class="textarea" type="text" name="title" value="<?php echo stripslashes($row->title); ?>" size="50" maxlength="50" title="" />
					</td>
				</tr>
				<tr>
					<td><?php echo _CATEGORY_NAME?>:</td>
					<td colspan="2">
						<input class="textarea" type="text" name="name" value="<?php echo stripslashes($row->name); ?>" size="50" maxlength="255" title="" />
					</td>
				</tr>
				<tr>
