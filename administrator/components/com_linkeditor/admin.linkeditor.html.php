...
<table class="adminlist">
	<tr>
		...
		<th width="1%"><a href="javascript: saveorder( <?php echo count($rows) - 1; ?> )"><img src="images/filesave.png" width="16" height="16" alt="Save Order" /></a></th>
	</tr>
<?php
		$k = 0;
		$i = 0;
...
?>
	<tr class="row<?php echo $k; ?>">
		...
		<td align="center">
			<img src="<?php echo $mosConfig_live_site; ?>/includes/<?php echo $img; ?>" alt="" />
		</td>
		<td align="left"><a href="<?php echo $link; ?>"><?php echo stripslashes($row->treename); ?></a></td>
		<td align="left"><?php echo $row->admin_menu_alt; ?></td>
		<td align="center">
			<img src="images/<?php echo ($row->iscore)?'tick.png':'publish_x.png'; ?>" alt="<?php echo ($row->iscore) ? 'Да':'Нет'; ?>" />
		</td>
...
?>
	...
	<table class="adminheading">
		...
		<tr>
			...
			<img name="view_imagefiles" src="<?php echo $mosConfig_live_site; ?>/includes/<?php echo ($row->admin_menu_img !='js/ThemeOffice/')?$row->admin_menu_img:'js/ThemeOffice/spacer.png'; ?>" width="16" alt="" />
