...
?>
				...
				<td align="center" id="acc-id-<?php echo $row->id;?>">
				<?php echo $access; ?>
				</td>
				<td align="center">
				<a href="<?php echo $link_aktiv_cat;?>" title="<?php echo _VIEW_SECTION_CATEGORIES?>"><?php echo $row->categories; ?></a>
				</td>
				<td align="center">
				<a href="<?php echo $link_aktiv;?>" title="<?php echo _VIEW_SECTION_CONTENT?>"><?php echo $row->active; ?></a>
				</td>
				<td align="center">
				<?php echo $row->trash; ?>
				</td>
...
?>
	<script type="text/javascript">
		...
		<tr>
			<th class="sections">
			Раздел:
			<small><?php echo $row->id?_O_EDITING:_O_CREATION; ?> [ <?php echo stripslashes($name); ?> ]</small></small>
			</th>
		</tr>
		</table>
		<table width="100%">
		<tr>
			<td valign="top" width="60%">
				...
				<tr>
					...
					<td colspan="2">
					<input class="textarea" type="text" name="title" value="<?php echo $row->title; ?>" size="50" maxlength="50" title="<?php echo _MENU_SHORT_NAME?>" />
					</td>
				</tr>
				<tr>
					<td>
					<?php echo _CMN_NAME?> <?php echo (isset($row->section)?_SECTION_NAME_OF_CATEGORY:_SECTION_NAME_OF_SECTION); ?>:
					</td>
					<td colspan="2">
						<input class="textarea" type="text" name="name" value="<?php echo $row->name; ?>" size="50" maxlength="255" title="<?php echo _SECTION_NAME_TIP?>" />
					</td>
				</tr>
				<tr>
...
?>
		...
		<tr>
			...
			<br />
			<input class="textarea" type="text" name="title" value="" size="35" maxlength="50" title="<?php echo _SECTION_NAME?>" />
			<br /><br />
			</td>
			...
			<td width="60%">
				<table width="100%" class="adminform">
					<tbody>
						...
						<tr>
							<td>
								<textarea style="width:100%;height:300px;" rows="40" cols="110" id="addcontent" name="addcontent"/></textarea>
							</td>
						</tr>
					</tbody>
				</table>
				...
				<tbody>
					...
					<tr>
						...
						<td>
							...
							<input onclick="return sectionclick();" type="radio" class="inputbox" checked="checked" value="0" id="secid" name="type"/><br />
							<label onclick="return catclick();" for="catid"><?php echo _CATEGORIES?></label>
							<input onclick="return catclick();" type="radio" class="inputbox" value="1" id="catid" name="type"/><br />
							<label onclick="return conclick();" for="conid"><?php echo _E_CONTENT?></label>
							<input onclick="return conclick();" type="radio" class="inputbox" value="2" id="conid" name="type"/><br />
						</td>
					</tr>
					<tr>
						<td width="150" align="left" valign="top"><?php echo _CMN_PUBLISHED?>:</td>
						<td>
							<label for="published0"><?php echo _CMN_NO?></label>
							<input type="radio" class="inputbox" value="0" id="published0" name="published"/><br />
					...
					<tr>
						<td width="150" align="left" valign="top"><?php echo _CMN_ACCESS?>:</td>
						<td>
							<select size="4" class="inputbox" name="access" style="width:100%;">
