...
$GLOBALS['error_msg'] = array( // ошибки
	'error' => 'ERROR(S)','back' => 'Back', // корневой каталог
...
$GLOBALS['messages'] = array( // ссылки
	'permlink' => 'Смена прав доступа','editlink' => 'Edit','downlink' =>
	'Download','uplink' => 'Up','homelink' => 'Корень','reloadlink' => 'Reload',
	'copylink' => 'Copy','movelink' => 'Move','dellink' => 'Delete',
	'comprlink' => 'Архивировать','adminlink' => 'Администрирование','logoutlink' =>
	'Logout','uploadlink' => 'Upload','searchlink' => 'Search','extractlink' =>
	...
	'nameheader' => 'Name','sizeheader' => 'Size','typeheader' => 'Type',
	'modifheader' => 'Изменен','permheader' => 'Права','actionheader' => 'Action(s)',
	'pathheader' => 'Путь', // buttons
	'btncancel' => 'Cancel','btnsave' => 'Save','btnchange' => 'Change',
	'btnreset' => 'Reset','btnclose' => 'Close','btncreate' => 'Creat',
	'btnsearch' => 'Search','btnupload' => 'Upload','btncopy' => 'Copy',
	'btnmove' => 'Move','btnlogin' => 'Login','btnlogout' => 'Logout',
	'btnadd' => 'Add','btnedit' => 'Edit','btnremove' => 'Remove',
	// Сообщения, joomlaXplorer 1.3.0 и выше
	'renamelink' => 'Rename','confirm_delete_file' =>
	...
	'miscitems' => 'item(s)','miscfree' => 'Free','miscusername' =>
	'Username','miscpassword' => 'Password','miscoldpass' => 'Old password',
	'miscnewpass' => 'New password','miscconfpass' => 'Подтвердите пароль',
	'miscconfnewpass' => 'Подтвердите новый пароль','miscchpass' =>
	'Поменять пароль','mischomedir' => 'Корневой каталог','mischomeurl' =>
	'Home URL','miscshowhidden' => 'Показывать спрятанные объекты',
	...
	'Ошибка при разархивировании','overwrite_files' => 'Overwrite file(s)?',
	...
	'returndir' => 'Вернуться в каталог после сохранения','line' => 'Line',
	'column' => 'Column','wordwrap' =>
	'Автоматический перенос строк: (только в IE)','copyfile' =>
	'Copy file in:', // Bookmarks
