			...
			<tr class="<?php echo "row".$k; ?>">
				...
				<td align="center">
					<a href="<?php echo $linkA; ?>" title="<?php echo _CHANGE_MENU_ITEMS?>">
						<img src="<?php echo $mosConfig_live_site; ?>/includes/js/ThemeOffice/mainmenu.png" alt="" />
					</a>
				</td>
				<td align="center">
<?php
...
?>
			...
			<img name="remove" src="images/delete.png" alt="<?php echo _CMN_DELETE?>" align="middle" />
			&nbsp;Удалить
			</a>
			</div>
			</td>
