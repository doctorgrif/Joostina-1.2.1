		...
		<tr valign="top">
			<td width="60%" valign="top">
				...
				<tr>
					...
					<td><input class="textarea" type="text" name="name" size="35" value="<?php echo $row->name; ?>" /></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td><input class="textarea" type="text" name="element" size="35" value="<?php echo $row->element; ?>" />.php</td>
				</tr>
				<tr>
