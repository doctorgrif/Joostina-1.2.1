...
?>
				...
				<td align="center" <?php echo $row->checked_out ? null : 'onclick="ch_front('.$row->id.');" class="td-state"';?>>
					<img class="img-mini-state" src="images/trash_mini.png" id="img-trash-<?php echo $row->id;?>" alt="" />
				</td>
<?php
			if($times) {
?>
...
?>
				...
				<td align="center" colspan="2">
					<input type="text" name="order[]" size="5" value="<?php echo $row->fpordering; ?>" class="textarea" style="text-align: center;" />
				</td>
