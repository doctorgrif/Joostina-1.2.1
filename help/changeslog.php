...
<li>Изменен логика отдачи DOCTYPE. Его вызов в шаблоне осуществляется по HTTP_USER_AGENT<pre><code>
...
<li>Изменен логика вывода favicon для IE - отдача также по HTTP_USER_AGENT (см. логику кода выше).</li>
<li>Изменен логика отдачи файла каскадного стиля с хаками для IE - отдача также по HTTP_USER_AGENT (см. логику кода выше).</li>
...
<li>Изменена логика вывода постраничной навигации (.pagenav_next, .pagenav_prev) в компоненте /components/com_content - из таблицы выведены в список, добавлены стили, языковые переменные дополнены необходимыми данными.</li>
<li>Изменена логика вывода иконок pdf/print/email/edit в компоненте /components/com_content, /components/com_contact и /includes/joomla.php - с табличного перенесено в слои. Изменена логика вывода заголовка содержимого (статьи/контакта). Добавлены необходимые стили.</li>
...
<li>Откровенно положил на IE - замучился прикручивать костыли. Если кто поможет исправить - буду только рад.</li>
<li>Временно отказался от joostinaopenid - вынесен из скрипта и инстяляционных файлов, модуль авторизации также поправлен.</li>
<li>Ограничил количество используемых плагинов jQuery - многое решено через css.</li>
</ol>
...
<li>Компонент com_contact частично переписан - изменена (где возможна) табличная структура вывода на списочный и вывод слоями. Добавлены необходимые стили.</li>
...
<li>Компонент com_registration частично переписан - изменена структура оформления стилей. Добавлены необходимые стили.</li>
<li>Компонент com_search частично переписан - изменена структура оформления стилей, логика вывода информации. Добавлены необходимые стили.</li>
<li>Компонент com_joostinapdf -  поправлена грамматическая ошибка в шаблоне *.pdf файла.</li>
</ol></li>
<li>Доработка модулей<ol>
<li>Модуль mod_search частично переписан - изменена структура оформления стилей. Добавлены необходимые стили.</li>
<li>Модуль mod_ml_login частично переписан - изменена структура оформления стилей. Добавлены необходимые стили.</li>
<li>Модуль mod_stats частично переписан - изменена структура оформления стилей. Добавлены необходимые стили.</li>
<li>Модуль mod_weblinkspercat частично переписан - изменена (где возможна) табличная структура вывода на списочный и вывод слоями. Добавлены необходимые стили.</li>
<li>Модуль mod_poll частично переписан - изменена (где возможна) табличная структура вывода на списочный и вывод слоями. Добавлены необходимые стили.</li>
<li>Модуль mod_archive частично переписан - изменена структура оформления стилей. Добавлены необходимые стили.</li>
<li>Модуль mod_section частично переписан - изменена структура оформления стилей. Добавлены необходимые стили.</li>
<li>Модуль mod_latestnews частично переписан - изменена структура оформления стилей. Добавлены необходимые стили.</li>
<li>Модуль mod_related_items частично переписан - изменена структура оформления стилей. Добавлены необходимые стили.</li>
</ol></li>
