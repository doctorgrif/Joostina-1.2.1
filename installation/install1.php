							...
							<table class="content2" width="100%">
								<tr>
									...
									<td>
										...
										Обычно это &nbsp;<strong>localhost</strong>
									</td>
								</tr>
								<tr>
									...
									<td>
										...
										Для установки на домашнем компьютере чаще всего используется имя&nbsp; <strong class="green">root</strong>, а для установки в Интернете, введите данные, полученные у Хостера.
									</td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td>
										...
										Используйте префикс таблиц для установки в одну БД. Не используйте <strong class="red">'old_'</strong> - это зарезервированное значение.
									</td>
								</tr>
								<tr>
