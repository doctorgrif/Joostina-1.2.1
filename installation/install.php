...
function writableCell($folder) {
	...
	echo '<td align="left">';
	echo is_writable("../$folder")?'<strong class="green">Доступен для записи</strong>':'<strong class="red">Недоступен для записи</strong>'."</td>";
	echo "</tr>";
}
	...
	<div id="ctr" align="center">
		<form action="install1.php" method="post" name="adminForm" id="adminForm">
			<div class="install">
				...
				<div id="wrap">
					<div class="clr"></div>
					<div class="install-text">Joostina - свободное программное обеспечение, распространяемое по лицензии GNU/GPL, для использования системы Вы должны полностью согласиться с предоставленной лицензией.</div>
					<div class="clr"></div>
