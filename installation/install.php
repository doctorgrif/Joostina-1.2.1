...
function writableCell($folder) {
	...
	echo '<td align="left">';
	echo is_writable("../$folder")?'<p class="strong green">Доступен для записи</p>':'<p class="strong red">Недоступен для записи</p>'."</td>";
	echo "</tr>";
}
echo '<!DOCTYPE html>';
echo "\n";
...
<form action="install1.php" method="post" name="adminForm" id="adminForm">
	<div class="install">
		...
		<div id="wrap">
			...
			<div class="install-text"><p>Joostina &ndash; свободное программное обеспечение, распространяемое по лицензии GNU/GPL, для использования системы Вы должны полностью согласиться с предоставленной лицензией.</p></div>
			<div class="clearfix"></div>
