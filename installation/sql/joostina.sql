# $Id: joostina.sql Joostina 1.2.1 boston &amp; doctorgrig $
...
INSERT INTO `#__components` VALUES (1, 'Баннеры', '', 0, 0, 'option=com_banners', 'Управление баннерами', 'com_banners', 0, 'js/ThemeOffice/baner16x16.png', 0, '');
...
INSERT INTO `#__components` VALUES (4, 'Категории', '', 0, 1, 'option=com_banners&task=categories', 'Управление категориями', 'com_banners', 2, 'js/ThemeOffice/categories.png', 0, '');
INSERT INTO `#__components` VALUES (5, 'Каталог ссылок', 'option=com_weblinks', 0, 0, '', 'Управление ссылками', 'com_weblinks', 0, 'js/ThemeOffice/globe2.png', 0, '');
INSERT INTO `#__components` VALUES (6, 'Ссылки', '', 0, 5, 'option=com_weblinks', 'Просмотр существующих ссылок', 'com_weblinks', 1, 'js/ThemeOffice/edit.png', 0, '');
INSERT INTO `#__components` VALUES (7, 'Категории', '', 0, 5, 'option=categories&section=com_weblinks', 'Управление категориями ссылок', '', 2, 'js/ThemeOffice/categories.png', 0, '');
INSERT INTO `#__components` VALUES (8, 'Контакты', 'option=com_contact', 0, 0, '', 'Редактировать контактную информацию', 'com_contact', 0, 'js/ThemeOffice/user.png', 1, '');
INSERT INTO `#__components` VALUES (9, 'Контакты', '', 0, 8, 'option=com_contact', 'Редактировать контактную информацию', 'com_contact', 0, 'js/ThemeOffice/edit.png', 1, '');
INSERT INTO `#__components` VALUES (10, 'Категории', '', 0, 8, 'option=categories&section=com_contact_details', 'Управление категориями контактов', '', 2, 'js/ThemeOffice/categories.png', 1, '');
INSERT INTO `#__components` VALUES (11, 'Главная страница', 'option=com_frontpage', 0, 0, '', 'Управление объектами главной страницы', 'com_frontpage', 0, 'js/ThemeOffice/component.png', 1, '');
INSERT INTO `#__components` VALUES (12, 'Опросы', 'option=com_poll', 0, 0, 'option=com_poll', 'Управление опросами', 'com_poll', 0, 'js/ThemeOffice/poll16x16.png', 0, '');
INSERT INTO `#__components` VALUES (13, 'Ленты новостей', 'option=com_newsfeeds', 0, 0, '', 'Управление настройками лент новостей', 'com_newsfeeds', 0, 'js/ThemeOffice/rss_go.png', 0, '');
INSERT INTO `#__components` VALUES (14, 'Ленты новостей', '', 0, 13, 'option=com_newsfeeds', 'Управление лентами новостей', 'com_newsfeeds', 1, 'js/ThemeOffice/edit.png', 0, '');
INSERT INTO `#__components` VALUES (15, 'Категории', '', 0, 13, 'option=com_categories&section=com_newsfeeds', 'Управление категориями', '', 2, 'js/ThemeOffice/categories.png', 0, '');
INSERT INTO `#__components` VALUES (16, 'Авторизация', 'option=com_login', 0, 0, '', '', 'com_login', 0, '', 1, '');
INSERT INTO `#__components` VALUES (17, 'Поиск', 'option=com_search', 0, 0, '', '', 'com_search', 0, '', 1, '');
INSERT INTO `#__components` VALUES (18, 'RSS экспорт', '', 0, 0, 'option=com_syndicate&hidemainmenu=1', 'Управление настройками экспорта новостей', 'com_syndicate', 0, 'js/ThemeOffice/rss.png', 0, '');
INSERT INTO `#__components` VALUES (19, 'Рассылка почты', '', 0, 0, 'option=com_massmail&hidemainmenu=1', 'Массовая рассылка почты', 'com_massmail', 0, 'js/ThemeOffice/mass_email.png', 0, '');
INSERT INTO `#__components` VALUES (20, 'Карта сайта', 'option=com_xmap', 0, 0, 'option=com_xmap', '', 'com_xmap', 0, 'js/ThemeOffice/map.png', 0, '');
...
INSERT INTO `#__mambots` VALUES (11,'Поиск контактов','contacts.searchbot','search',0,3,1,1,0,0,'0000-00-00 00:00:00','');
INSERT INTO `#__mambots` VALUES (12, 'Поиск категорий', 'categories.searchbot', 'search', 0, 4, 1, 0, 0, 0, '0000-00-00 00:00:00', '');
INSERT INTO `#__mambots` VALUES (13, 'Поиск разделов', 'sections.searchbot', 'search', 0, 5, 1, 0, 0, 0, '0000-00-00 00:00:00', '');
INSERT INTO `#__mambots` VALUES (14, 'Маскировка E-mail', 'mosemailcloak', 'content', 0, 5, 1, 0, 0, 0, '0000-00-00 00:00:00', '');
INSERT INTO `#__mambots` VALUES (15, 'Поиск лент новостей', 'newsfeeds.searchbot', 'search', 0, 6, 1, 0, 0, 0, '0000-00-00 00:00:00', '');
INSERT INTO `#__mambots` VALUES (16, 'Позиции загрузки модуля', 'mosloadposition', 'content', 0, 6, 1, 0, 0, 0, '0000-00-00 00:00:00', '');
INSERT INTO `#__mambots` VALUES (17, 'Первый обработчик содержимого', 'first', 'mainbody', 0, 0, 0, 0, 0, 0, '0000-00-00 00:00:00', '');
INSERT INTO `#__mambots` VALUES (18, 'Модуль на главной странице', 'frontpagemodule', 'content', 0, 0, 0, 0, 0, 0, '0000-00-00 00:00:00', 'mod_position=banner\nmod_type=1\nmod_after=1');
INSERT INTO `#__mambots` VALUES(19, 'Spaw', 'spaw', 'editors', 0, 0, 1, 0, 0, 0, '0000-00-00 00:00:00', '');
INSERT INTO `#__mambots` VALUES(20, 'Joostina socialbot', 'joostinasocialbot', 'content', 0, 1, 1, 0, 0, 0, '0000-00-00 00:00:00', 'textbefore=\ntextafter=');
INSERT INTO `#__mambots` VALUES(21, 'JoostinaTags', 'joostinatags', 'content', 0, 5, 1, 0, 0, 0, '0000-00-00 00:00:00', 'type_search=1');
...
INSERT INTO `#__modules` VALUES (8, 'Пользователи', '', 1, 'user9', 0, '0000-00-00 00:00:00', 1, 'mod_whosonline', 0, 0, 1, 'moduleclass_sfx=_info\nmodule_orientation=0\nall_user=1\nonline_user_count=0\nonline_users=0\nuser_avatar=0', 0, 0);
INSERT INTO `#__modules` VALUES (9, 'Популярное', '', 1, 'user6', 0, '0000-00-00 00:00:00', 1, 'mod_mostread', 0, 0, 1, 'moduleclass_sfx=\ncache=0\nnoncss=0\ntype=1\nshow_front=1\nshow_hits=0\ncount=3\ncatid=\nsecid=\ndef_itemid=0', 0, 0);
INSERT INTO `#__modules` VALUES (10, 'Выбор шаблона', '', 7, 'left', 0, '0000-00-00 00:00:00', 0, 'mod_templatechooser', 0, 0, 1, 'moduleclass_sfx=-tmpl\nshow_preview=1', 0, 0);
...
INSERT INTO `#__modules` VALUES (34, 'Спасибо за выбор Joostina!', '<p>Теперь мы вместе, и это очень радует. Если вас интересует вопрос «А почему именно Joostina?», мы хотели бы обратить ваше внимание на некоторые примечательные особенности этой CMS:</p><ul class="marker_round"><li> <strong>1</strong>Удачное сочетание мощности, скорости работы и нетребовательности к ресурсам сервера. Да, бывает и такое.</li><li> <strong>2</strong>Расширяемость за счет использования сторонних компонентов и модулей. А также простота разработки расширений для Joostina CMS.</li><li> <strong>3</strong>Данный продукт разрабатывается с большой любовью к коду и огромным вниманием к пользователям. И наоборот.</li></ul><p><a class="readmore_big" href="http://www.joostina.ru/">Узнать больше</a></p>', 1, 'user2', 0, '0000-00-00 00:00:00', 1, '', 0, 0, 1, 'moduleclass_sfx=\ncache=0\nfirebots=1\nrssurl=\nrsstitle=1\nrssdesc=1\nrssimage=1\nrssitems=3\nrssitemdesc=1\nword_count=0\nrsscache=3600', 0, 0);
INSERT INTO `#__modules` VALUES (37, 'Случайное фото', '', 1, 'user7', 0, '0000-00-00 00:00:00', 1, 'mod_random_image', 0, 0, 1, 'rotate_type=0\ntype=jpg\nfolder=images/rotate\nlink=http://www.joostina.ru\nwidth=180\nheight=150\nmoduleclass_sfx=-random_image\nslideshow_name=jstSlideShow_1\nimg_pref=pic\ns_autoplay=1\ns_pause=2500\ns_fadeduration=500\npanel_height=55px\npanel_opacity=0.4\npanel_padding=5px\npanel_font=bold 11px Verdana', 0, 0);
INSERT INTO `#__modules` VALUES (38, 'Полезная информация', '<ul class="li"><li>Файлы шаблонов Joostina CMS находятся в templates/­[название_­вашего_­шаблона] </li><li>Отключите в глобальной конфигурации ненужные функции и мамботы для ускорение работы сайта </li><li>Правильно настроенное кэширование - залог здоровья высокопосещаемого сайта </li></ul>', 1, 'user8', 0, '0000-00-00 00:00:00', 1, '', 0, 0, 1, 'moduleclass_sfx=-addinfo\ncache=0\nfirebots=1\nrssurl=\nrsstitle=1\nrssdesc=1\nrssimage=1\nrssitems=3\nrssitemdesc=1\nword_count=0\nrsscache=3600', 0, 0);
...
INSERT INTO `#__modules` VALUES(40, 'Загрузить Joostina', '', 3, 'left', 0, '0000-00-00 00:00:00', 1, 'mod_downloadjoostina', 0, 0, 1, 'moduleclass_sfx=-djmod\njoostina12=1.2.1\njoostina13=1.3.0\njoostina12link=http://joostina121.googlecode.com/\njoostina13link=http://code.google.com/p/joostina/\njoostina12\njoostina13', 0, 0);
INSERT INTO `#__modules` VALUES(41, 'Ссылки в категории', '', 1, 'left', 0, '0000-00-00 00:00:00', 1, 'mod_weblinkspercat', 0, 0, 1, 'moduleclass_sfx=\ncache=0\nwlcategory=0\nwlshownew=0\nwldaysnew=3\nwlorderby=date DESC\nwlshowhits=0\nwlnumberofrows=10\nwlpopuplinks=1\nwllengthoftitle=23\nwldotaddlenght=20\nwlreadmore=0', 0, 0);
...
INSERT INTO `#__template_positions` VALUES (0, 'user10', '');
