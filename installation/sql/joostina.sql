...
INSERT INTO `#__modules` VALUES (34, 'Спасибо за выбор Joostina!', '<p>\r\nТеперь мы вместе, и это очень радует. Если вас интересует вопрос &laquo;А почему именно Joostina?&raquo;, мы хотели бы обратить ваше внимание на некоторые примечательные особенности этой CMS:</p>\r\n<ul class="marker_round">\r\n<li>\r\n<strong>1</strong>Удачное сочетание мощности, скорости работы и нетребовательности к ресурсам сервера. Да, бывает и такое.</li>\r\n<li>\r\n<strong>2</strong>Расширяемость за счет использования сторонних компонентов и модулей. А также простота разработки расширений для Joostina CMS.</li>\r\n<li>\r\n<strong>3</strong>Данный продукт разрабатывается с большой любовью к коду и огромным вниманием к пользователям. И наоборот.</li>\r\n</ul>\r\n<a class="readmore_big" href="http://www.joostina.ru/">Узнать больше</a>\r\n', 1, 'user2', 0, '0000-00-00 00:00:00', 1, '', 0, 0, 1, 'moduleclass_sfx=\ncache=0\nfirebots=1\nrssurl=\nrsstitle=1\nrssdesc=1\nrssimage=1\nrssitems=3\nrssitemdesc=1\nword_count=0\nrsscache=3600', 0, 0);
