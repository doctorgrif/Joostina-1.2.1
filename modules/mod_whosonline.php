...
$params_aray = array(// ќсновные настройки
	'moduleclass_sfx' => $params->get('moduleclass_sfx'), // —уффикс класса модул€
	'all_user' => $params->get('all_user'), //  оличество зарегистрированных пользователей
	'online_user_count' => $params->get('online_user_count'), // ѕользователи online
	'online_users' => $params->get('online_users'), //  то online
	'user_avatar' => $params->get('user_avatar'), // јватары пользователей
	'module_orientation' => $params->get('module_orientation'), // ќриентаци€ модул€
);
$output = '';
...
// проверка наличи€ гостей и зарегистрированных пользователей на сайте
